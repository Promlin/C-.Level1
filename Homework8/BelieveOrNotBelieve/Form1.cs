...
namespace BelieveOrNotBelieve
{
    public partial class Form1 : Form
    {
        ...
        {
            DialogResult dialogResult = MessageBox.Show("Уверены что хотите удалить запись?", "Some Title", MessageBoxButtons.YesNo);
        ...
        {
            MessageBox.Show("Предположительно здесь информация о программе");
        }
    }
}
